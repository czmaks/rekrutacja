...
--
-- Name: ebooks; Type: TABLE; Schema: public; Owner: maks
--
...
ALTER TABLE public.ebooks OWNER TO maks;

--
-- Name: ebooks_id_seq; Type: SEQUENCE; Schema: public; Owner: maks
--
...
ALTER SEQUENCE public.ebooks_id_seq OWNER TO maks;

--
-- Name: ebooks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: maks
--
...
--
-- Name: nbp_data; Type: TABLE; Schema: public; Owner: maks
--
...
ALTER TABLE public.nbp_data OWNER TO maks;

--
-- Name: nbp_data_id_seq; Type: SEQUENCE; Schema: public; Owner: maks
--
...
ALTER SEQUENCE public.nbp_data_id_seq OWNER TO maks;

--
-- Name: nbp_data_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: maks
--
...
--
-- Name: ebooks id; Type: DEFAULT; Schema: public; Owner: maks
--
...
--
-- Name: nbp_data id; Type: DEFAULT; Schema: public; Owner: maks
--
...
--
-- Data for Name: ebooks; Type: TABLE DATA; Schema: public; Owner: maks
--
...
--
-- Data for Name: nbp_data; Type: TABLE DATA; Schema: public; Owner: maks
--
...
--
-- Name: ebooks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: maks
--
...
--
-- Name: nbp_data_id_seq; Type: SEQUENCE SET; Schema: public; Owner: maks
--
...
--
-- Name: ebooks ebooks_pkey; Type: CONSTRAINT; Schema: public; Owner: maks
--
...
--
-- Name: nbp_data nbp_data_pkey; Type: CONSTRAINT; Schema: public; Owner: maks
--
...
--
-- Name: ix_ebooks_id; Type: INDEX; Schema: public; Owner: maks
--
...
--
-- Name: ix_ebooks_name; Type: INDEX; Schema: public; Owner: maks
--
...
--
-- Name: ix_nbp_data_id; Type: INDEX; Schema: public; Owner: maks
--
...
--
-- Name: nbp_data nbp_data_ebook_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: maks
--
